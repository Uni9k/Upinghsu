...
<div id="post-bottom-bar" class="post-bottom-bar">
	<div class="bottom-bar-inner">
		<div class="bottom-bar-items social-share left">
			...
			<span class="bottom-bar-item bottom-bar-weibo"><a href="http://service.weibo.com/share/share.php?url=<?php echo urlencode($this->permalink()); ?>&amp;title=【<?php echo urlencode($this->title()); ?>】<?php echo urlencode($this->excerpt(75, '...')); ?>" target="_blank" title="<?php $this->title() ?>" rel="nofollow">Weibo</a></span>
